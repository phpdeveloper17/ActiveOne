...
class Create extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($rowId) {
            ...
            $rowTitle = $rowData->getPurchaseCapId();
            if (!$rowData->getId()) {
        ...
        $title = $rowId ? __('Edit ').$rowTitle : __('Add Purchase Cap Limit');
    ...
    {
        return $this->_authorization->isAllowed('Unilab_Benefits::create_purchase');
    }
}
