...
class Create extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($rowId) {
            ...
            $rowTitle = $rowData->getTransactionName();
            if (!$rowData->getId()) {
                $this->messageManager->addError(__('row data no longer exist.'));
                $this->_redirect('unilab_benefits/TransactionTypeController/index');
                return;
            }
        }
        ...
        $title = $rowId ? __('Edit ').$rowTitle : __('Add Transaction Type');
    ...
    {
        return $this->_authorization->isAllowed('Unilab_Benefits::create_transactiontype');
    }
}
