...
class Importresult extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->addButton(
            'import_new_pricelevel',
            [
                'label' => __('Import New Price Level'),
                'onclick' => 'setLocation(\'' . $this->getUrl('unilab_benefits/pricelevel/import') . '\')',
                'class' => 'import_new_pricelevel primary'
            ],
            -1
        );
