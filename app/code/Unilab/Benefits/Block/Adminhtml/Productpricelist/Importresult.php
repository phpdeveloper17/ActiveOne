...
class Importresult extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->addButton(
            'import_new_productpricelist',
            [
                'label' => __('Import New Product Price List'),
                'onclick' => 'setLocation(\'' . $this->getUrl('unilab_benefits/productpricelist/import') . '\')',
                'class' => 'import_new_productpricelist primary'
            ],
            -1
        );
