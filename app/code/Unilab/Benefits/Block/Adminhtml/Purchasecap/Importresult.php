<?php
     ...
     */
    namespace Unilab\Benefits\Block\Adminhtml\Purchasecap;
...
class Importresult extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_purchasecap';
        parent::_construct();//It sets back, reset, delete, and save buttons with default values
        $this->addButton(
            'import_new_product_pricelist',
            [
                'label' => __('Import New Purchase Cap Limit'),
                'onclick' => 'setLocation(\'' . $this->getUrl('unilab_benefits/purchasecapcontroller/import') . '\')',
                'class' => 'import_new_purchasecap primary'
            ],
            -1
        );
