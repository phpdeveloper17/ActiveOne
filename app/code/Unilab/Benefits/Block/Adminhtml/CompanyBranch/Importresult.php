...
class Importresult extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->addButton(
            'import_companyaddress',
            [
                'label' => __('Import Company Address'),
                'onclick' => 'setLocation(\'' . $this->getUrl('unilab_benefits/companybranchcontroller/import') . '\')',
                'class' => 'import_companyaddress primary'
            ],
            -1
        );
