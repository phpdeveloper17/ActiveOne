...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($rowId) {
            ...
            if (!$rowData->getAsciiId()) {
                $this->messageManager->addError(__('ASCII Equivalent no longer exist.'));
        ...
        $title = __('Edit ASCII Equivalent ').$rowTitle;
    ...
    {
        return $this->_authorization->isAllowed('Unilab_DigitalCouponing::edit_asciiequivalent');
    }
}
