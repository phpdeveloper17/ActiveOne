...
define(
     ...
     function ($, Component, fullScreenLoader,url) {
        ...
        return Component.extend({
            defaults: {
                template: 'Unilab_DragonPay/payment/dragonpayform',
                transactionResult: ''
            },
            ...
            continueTodragonpay: function (lastOrderId) {
            ...
            afterPlaceOrder: function (lastOrderId) {
                ...
                $.mage.redirect(url.build('dragonpay/payment/redirect/?ts='+ (new Date()).getTime()));
            }
