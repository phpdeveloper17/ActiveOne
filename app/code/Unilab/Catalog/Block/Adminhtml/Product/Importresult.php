<?php
     ...
     */
    namespace Unilab\Catalog\Block\Adminhtml\Product;
...
class Importresult extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'id';
        $this->_blockGroup = 'Unilab_Catalog';
        $this->_controller = 'adminhtml_product';
        
        parent::_construct();//It sets back, reset, delete, and save buttons with default values
        $this->buttonList->update('back', 'onclick', "setLocation('" . $this->getUrl('unilab_catalog/product/import') . "')");
