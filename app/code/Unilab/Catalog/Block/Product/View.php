...
class View extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    public function getCheckoutQuoteId()
    {
        return $this->checkoutSession->getQuoteId();
    }

    public function isDcEnabled()
    {
        return $this->scopeConfig->getValue('digitalcouponing/dcmaintenance/enabled', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
