...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function getInquiryFormattedDate()
    {
    ...
    public function getInquiryDepartment()
    {
        $departments = $this->_departmentHelper->getDepartmentByCodeCstm($this->getInquiry()->getDepartment());
    ...
    {
        $date = $this->_dateFormatter->date(new \DateTime($this->getInquiry()->getCreatedTime()))->format('M d, Y h:i:s A');

        return $date;
    }

    public function getBackendUrlHelper()
    {
        return $this->_backendUrlHelper;
    }
