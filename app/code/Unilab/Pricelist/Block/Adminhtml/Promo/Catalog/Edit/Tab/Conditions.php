 ...
 */
namespace Unilab\Pricelist\Block\Adminhtml\Promo\Catalog\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'pricelist_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
        ...
        $renderer = $this->_rendererFieldset->setTemplate('Unilab_Pricelist::promo/fieldset.phtml')
