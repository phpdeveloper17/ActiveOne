...
class Pricelist extends \Magento\Framework\Model\AbstractModel 
{
    ...
    const CACHE_TAG = 'wspi_pricelist';

    protected $_cacheTag = 'wspi_pricelist';


    protected $_eventPrefix = 'wspi_pricelist';


    protected function _construct()
    {
        $this->_init('Unilab\Pricelist\Model\ResourceModel\Pricelist');
    }
