...
namespace Unilab\Reports\Block\Adminhtml\Filter;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $orderConfig = $this->_objectManager->get("\Magento\Sales\Model\Order\ConfigFactory");
        $statuses = $orderConfig->create()->getStatuses();
        $values = [];
