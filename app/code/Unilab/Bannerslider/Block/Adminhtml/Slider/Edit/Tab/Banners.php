...
class Banners extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \Unilab\Bannerslider\Model\ResourceModel\Banner\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'width' => '50px',
                'renderer' => 'Unilab\Bannerslider\Block\Adminhtml\Banner\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'title',
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Unilab\Bannerslider\Block\Adminhtml\Slider\Edit\Tab\Helper\Renderer\EditBanner',
            ]
        );
