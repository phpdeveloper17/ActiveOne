 ...
 */
namespace Unilab\Bannerslider\Block\Adminhtml\Report;
use Unilab\Bannerslider\Model\ResourceModel\Report\Collection as ReportCollection;
/**
 * Report grid.
 * @category Unilab
 * @package  Unilab_Bannerslider
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \Unilab\Bannerslider\Model\ResourceModel\Report\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter' => false,
                'index' => 'imagename',
                'renderer' => 'Unilab\Bannerslider\Block\Adminhtml\Report\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'date_click',
