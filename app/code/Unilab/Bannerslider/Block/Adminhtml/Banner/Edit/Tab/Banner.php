...
namespace Unilab\Bannerslider\Block\Adminhtml\Banner\Edit\Tab;
...
class Banner extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Unilab\Bannerslider\Model\Banner
     */
    protected $_banner;
    ...
    public function __construct(
        ...
        \Unilab\Bannerslider\Model\Banner $banner,
    ...
    protected function _prepareLayout()
    {
        ...
        \Magento\Framework\Data\Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock(
                'Unilab\Bannerslider\Block\Adminhtml\Form\Renderer\Fieldset\Element',
...
//            $datetime = new \DateTime($dataObj->getData('end_time'));
        ...
        $elements['target'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Unilab\Bannerslider\Model\Banner::BANNER_TARGET_SELF,
                        'label' => __('New Window with Browser Navigation'),
                    ],
                    [
                        'value' => \Unilab\Bannerslider\Model\Banner::BANNER_TARGET_PARENT,
                        'label' => __('Parent Window with Browser Navigation'),
                    ],
                    [
                        'value' => \Unilab\Bannerslider\Model\Banner::BANNER_TARGET_BLANK,
