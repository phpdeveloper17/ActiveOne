...
class Preview extends \Magento\Backend\Block\Template
{
     ...
     */
    const STYLESLIDE_EVOLUTION_PREVIEW_TEMPLATE = 'Unilab_Bannerslider::slider/preview/evolution.phtml';
    const STYLESLIDE_SPECIAL_NOTE_PREVIEW_TEMPLATE = 'Unilab_Bannerslider::slider/preview/special/note.phtml';
    const STYLESLIDE_FLEXSLIDER_PREVIEW_TEMPLATE = 'Unilab_Bannerslider::slider/preview/flexslider.phtml';
