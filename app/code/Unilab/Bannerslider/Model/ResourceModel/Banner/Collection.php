...
namespace Unilab\Bannerslider\Model\ResourceModel\Banner;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Unilab\Bannerslider\Model\Banner', 'Unilab\Bannerslider\Model\ResourceModel\Banner');
    }
    ...
    public function __construct(
        ...
        \Unilab\Bannerslider\Model\Slider $slider,
        $connection = null,
    ...
    public function joinSliderTitle()
    {
        $this->getSelect()->joinLeft(
            ['sliderTable' => $this->getTable('unilab_bannerslider_slider')],
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        ...
        if (in_array($field, $attributes) && $storeViewId) {
            if (!in_array($field, $this->_addedTable)) {
                ...
                $this->getSelect()
                    ->joinLeft(array($field => $this->getTable('unilab_bannerslider_value')), $sql, array());
    ...
    public function getBannerCollection($sliderId)
    {
        ...
        /** @var \Unilab\Bannerslider\Model\ResourceModel\Banner\Collection $bannerCollection */
        $bannerCollection = $this->setStoreViewId($storeViewId)
            ->addFieldToFilter('slider_id', $sliderId)
            ->addFieldToFilter('status', \Unilab\Bannerslider\Model\Status::STATUS_ENABLED)
            ->addFieldToFilter('start_time', ['lteq' => $dateTimeNow])
            ->addFieldToFilter('end_time', ['gteq' => $dateTimeNow])
            ->setOrder('order_banner', 'ASC');

        if ($this->_slider->getSortType() == \Unilab\Bannerslider\Model\Slider::SORT_TYPE_RANDOM) {
