...
namespace Unilab\Bannerslider\Model\ResourceModel\Report;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Unilab\Bannerslider\Model\Report', 'Unilab\Bannerslider\Model\ResourceModel\Report');
    }
    ...
    public function reportClickAndImpress($reportType)
    {
        $this->getSelect()->joinLeft(
            ['table_banner' => $this->getTable('unilab_bannerslider_banner')],
            'main_table.banner_id = table_banner.banner_id',
            ['banner_name' => 'table_banner.name', 'banner_url' => 'table_banner.click_url']
        )->joinLeft(
            ['table_slider' => $this->getTable('unilab_bannerslider_banner')],
