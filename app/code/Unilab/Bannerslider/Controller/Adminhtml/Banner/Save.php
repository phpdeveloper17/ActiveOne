 ...
 */
class Save extends \Unilab\Bannerslider\Controller\Adminhtml\Banner
{
    /**
            ...
            if ($imageRequest && strlen($fileName)) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath(\Unilab\Bannerslider\Model\Banner::BASE_MEDIA_PATH)
                    );
                    $data['image'] = \Unilab\Bannerslider\Model\Banner::BASE_MEDIA_PATH.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
