 ...
 */
class ExportXml extends \Unilab\Bannerslider\Controller\Adminhtml\Banner
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Unilab\Bannerslider\Block\Adminhtml\Banner\Grid')->getXml();
