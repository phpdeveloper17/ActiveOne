 ...
 */
class ExportXml extends \Unilab\Bannerslider\Controller\Adminhtml\Slider
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Unilab\Bannerslider\Block\Adminhtml\Slider\Grid')->getXml();
