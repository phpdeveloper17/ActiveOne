...
namespace Unilab\Bannerslider\Controller\Adminhtml;
 ...
 */
abstract class CoreSlider extends \Unilab\Bannerslider\Controller\Adminhtml\AbstractAction
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Unilab_Bannerslider::bannerslider_coreslider');
    }
}
