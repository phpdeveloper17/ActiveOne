 ...
 */
abstract class Report extends \Unilab\Bannerslider\Controller\Adminhtml\AbstractAction
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Unilab_Bannerslider::bannerslider_reports');
    }
}
