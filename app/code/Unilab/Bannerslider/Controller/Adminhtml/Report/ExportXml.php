 ...
 */
class ExportXml extends \Unilab\Bannerslider\Controller\Adminhtml\Report
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Unilab\Bannerslider\Block\Adminhtml\Report\Grid')->getXml();
