<?php
     ...
     */
namespace Unilab\Customers\Block\Adminhtml\Group;
...
class Importresult extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        $this->addButton(
            'import_new_customergroup',
            [
                'label' => __('Import New Customer Group'),
                'onclick' => 'setLocation(\'' . $this->getUrl('unilab_customers/group/import') . '\')',
                'class' => 'import_new_customergroup primary'
            ],
            -1
        );
