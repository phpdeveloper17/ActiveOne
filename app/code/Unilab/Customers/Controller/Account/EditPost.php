 ...
 */
namespace Unilab\Customers\Controller\Account;
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            try {
                ...
                if (strtolower($request['current_password']) == strtolower($request['password'])) {
                    //new password can't be the same with old password
                    $this->messageManager->addError('New password can\'t be the same with old password');
                    return $resultRedirect->setPath('customer/*/edit');
                }
                ...
                if(!empty($request['civil_status'])){
                    $customerCandidateDataObject->setCustomAttribute('civil_status', $request['civil_status']);
                }
                if(!empty($request['agree_on_terms'])){
                    $customerCandidateDataObject->setCustomAttribute('agree_on_terms', $request['agree_on_terms']);
                }
