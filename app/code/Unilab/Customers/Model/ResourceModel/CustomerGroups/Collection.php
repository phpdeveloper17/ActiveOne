...
namespace Unilab\Customers\Model\ResourceModel\CustomerGroups;
...
class Collection extends AbstractCollection
{
     ...
     */
    const YOUR_TABLE = 'customer_group';

    protected $_idFieldName = 'customer_group_id'; //this field id used to delete [id]=> of maintable[unilab_mov_shipping]
    ...
    public function __construct(
        ...
        $this->_init(
            'Unilab\Customers\Model\CustomerGroups',
            'Unilab\Customers\Model\ResourceModel\CustomerGroups'
        );
        parent::__construct(
